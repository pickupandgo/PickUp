...
const MapCanvas: React.FC<MapCanvasProps> = ({
  ...
  // blank if `tracksViewChanges` is false at mount. Toggling it on for ~1 s
  // after any marker change re-renders every marker properly. Doing it only
  // on first mount misses markers that arrive later.
